...
Server startup:
java -cp pa2.jar FileServer start <portnumber>

Client startup:
set PA1_SERVER=localhost:<port number>

port_number can be any number. 
For example 4098.

Commands for uploadig and downloading the file:
java -cp pa2.jar Client upload <client_path> <server_path>
java -cp pa2.jar Client download <server_path> <client_path>

Commands for controlling the directories the file:
java -cp pa2.jar Client dir <server_path>
java -cp pa2.jar Client mkdir <server_path>
java -cp pa2.jar Client rmdir <server_path>
java -cp pa2.jar Client rm <server_path>
...
java -cp pa2.jar client mkdir </path/new_directory/on/server>
java -cp pa2.jar client rmdir </path/existing_directory/on/server>
java -cp pa2.jar client rm </path/existing_filename/on/server>
java -cp pa2.jar client shutdown
